...
const useNoCookieInput = document.getElementById("useNoCookieInput")
...
window.onYouTubeIframeAPIReady = function () {
    ...
    player = new YT.Player("player", {
        ...
        host: useNoCookieInput.checked ? "http://www.youtube-nocookie.com" : "http://www.youtube.com",
        playerVars: {
            autoplay: 0,
            controls: 0,
            modestbranding: 1,
...
function saveSettings() {
    ...
    if (!nextSettings.permanentlyDisabled) {
